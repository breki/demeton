...
/// <summary>
/// Given a map projection type and map scale, creates map projection
/// functions for it.
/// </summary>
    ...
    | LambertConformalConic parameters ->
        ...
        |> Result.map (fun () ->
            LambertConformalConic
                .MapProjection(parameters, mapScale)
                .projection)
    | Mercator -> Mercator.MapProjection(mapScale).projection |> Ok
